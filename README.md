...
#### This repo is for a random quote generator project from freeCodeCamp's Front End Development Certifcation.

### Quick Start
Clone the repo:
```
git clone https://github.com/ianagpawa/random-quote.git
```
