...
function startPage(){
  ...
  function randomQuote() {
    ...
    var quotesHash = {
      ...
      61: ["Don't feel bad.  A lot of people have no talent.", "Unknown"],
      ...
      67: ["Jerry, just remember:  It's not a lie if you believe.", "George Costanza"],
      ...
      69: ["Hello Super-Nintendo Chalmers", "Ralph Wiggum"],
